...
# Age from ruling_date (YYYY-MM-DD)
...
# Use income_amount as revenue (better coverage than revenue_amount)
if "income_amount" in bmf.columns:
    bmf["REVENUE_AMT"] = pd.to_numeric(bmf["income_amount"], errors="coerce").fillna(0)
else:
    bmf["REVENUE_AMT"] = 0

# Filters - codes are NUMERIC, not strings
...
if "foundation_code" in bmf.columns:
    # 15 = private operating, 16 = private non-operating
