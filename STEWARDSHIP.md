...
| 2026-07-13 | Akbar Khowaja (approved) · Claude Code (drafted) | Daanaa Charter v1.0 adopted and published at daanaa.org/charter (`institution/DAANAA-CHARTER.md`) — ten public never-promises binding on all contributors and AI agents. Supporting corpus adopted same day: Tier 0/1/2 data classification (`institution/library/011_data_classification.md`, enforced by privacy_check.sh GATE 8 + PRIVACY-INVARIANTS #8) and consulting-client conflict rules (VENDOR-POLICY.md). Entity decision: Daanaa remains DBA of EcoMargins Consulting LLC with a code-level firewall; 501(c)(3) spin-out deferred to post-pilot board gate. Principle text unchanged. |
...
| 2026-06-14 | Claude Code | Daanaa Impact Network (guild/vendor system) launched. P7 gap identified: no formal policy prevented vendor relationships from influencing org scores/rankings. Resolution: drafted and adopted VENDOR-POLICY.md — explicit structural prohibition on vendor influence over rankings, scores, or visibility (P7); data limits prohibiting sharing of donor/giving data with vendors (P2); no-endorsement clause (P3); indemnification protecting platform independence (P7); values-alignment eligibility requirement (P1). Policy references Stewardship Commitment as governing document. | Completed |
| 2026-07-01 | Claude Code | Sprint review covering: persona tiles (E2), proximity search UI, volunteer badge (E5), ProPublica leadership + compensation (E6), print export (E7), visibility brand shell + Plausible injection, research freshness date. P1/P4/P5/P6/P7/P8/P10/P11 pass clean. Gap found on P3+P9: E6 showed 990 compensation amounts without disclosing the filing year (data can be 18–24 months old per IRS filing timelines). Fix applied in same session: `tax_prd_yr` now captured from ProPublica API and shown in attribution line ("IRS Form 990, 2022 filing via ProPublica · public record"). E6 architectural decision logged in DECISIONS.md. Future constraint documented on P2: any planned "near me" geolocation button must reverse-geocode to zip code client-side only; raw browser coordinates must never reach the server. | Completed |
