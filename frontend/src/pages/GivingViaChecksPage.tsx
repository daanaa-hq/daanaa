      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-[26px] md:text-[32px] mb-10">How to give by check</h2>

            <div className="space-y-8">
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <span className="font-display text-deep-navy text-[24px]">1</span>
                  <h3 className="font-display text-deep-navy text-[20px]">Find the nonprofit's address</h3>
                </div>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Write your check</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
                  Fill out a check:
                </p>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Mail it</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Keep your records</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-[20px] md:text-[24px] mb-6">Why give by check?</h2>
