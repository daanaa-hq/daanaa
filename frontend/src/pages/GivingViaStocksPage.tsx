        ...
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <div className="bg-soft-gold/10 border border-soft-gold/20 rounded-lg p-6 mb-8">
              <h3 className="font-display text-deep-navy text-[18px] mb-3">🎯 Why donate stock?</h3>
              ...
              <p className="font-body text-[12px] text-muted-cream/70 mt-3 italic">
                ⚠️ This is not tax advice. Tax benefits depend on your situation. Consult a tax professional.
              </p>
            </div>

            <h2 className="font-display italic text-deep-navy text-[26px] md:text-[32px] mb-10">How to donate stock</h2>

            <div className="space-y-8">
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <span className="font-display text-deep-navy text-[24px]">1</span>
                  <h3 className="font-display text-deep-navy text-[20px]">Contact the nonprofit</h3>
                </div>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">They'll give you brokerage details</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Transfer stock through your broker</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Get a receipt and consult a tax pro</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-[20px] md:text-[24px] mb-6">Important to know</h2>
          ...
          {/* Tax information */}
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-[20px] md:text-[24px] mb-6">Tax guidance</h2>
            <div className="bg-soft-gold/10 border border-soft-gold/20 rounded-lg p-6">
              ...
              <ul className="font-body text-[14px] text-cool-grey leading-[1.65] space-y-2">
                <li>
                ...
                <li>
                  📄 <a href="https://www.irs.gov/individuals/international-taxpayers/frequently-asked-questions-on-virtual-currency-transactions" target="_blank" rel="noopener noreferrer" className="text-link-gold hover:text-bright-gold">
                    IRS guidance on appreciated assets
                  </a>
                </li>
              </ul>
              <p className="font-body text-[12px] text-muted-cream/70 mt-4 italic">
                ⚠️ This is educational information only, not tax advice. Consult a tax professional for your specific situation.
              </p>
            </div>
          </section>
