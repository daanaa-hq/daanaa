          ...
          <div className={`p-4 rounded-lg border ${
            ...
            <div className="flex gap-3">
              <div className="flex-shrink-0 mt-0.5">
                <svg className={`w-5 h-5 ${showPreviewMode ? 'text-blue-600' : 'text-green-600'}`} fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex-1">
                {showPreviewMode ? (
                  <>
                    <p className="font-medium text-blue-900 mb-1">Preview Mode</p>
                    <p className="text-sm text-blue-800 mb-2">
                      You can explore and preview the wallet. Your data won't be saved until you sign in with Google.
                    </p>
                    <button
                  ...
                  <>
                    <p className="font-medium text-green-900 mb-1">Your data is private and secure</p>
                    <p className="text-sm text-green-800">
                      Your wallet data is stored only on your account. We never share your giving history, volunteering records, or saved organizations with third parties or use them for marketing.
                    </p>
                  </>
                )}
              </div>
