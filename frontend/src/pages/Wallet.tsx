    ...
    return (
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 py-12">
        <div className="text-center">
          <h1 className="text-3xl font-display text-deep-navy mb-4">Impact Wallet</h1>
          <p className="text-lg text-cool-grey mb-6">Sign in to track your giving and volunteering</p>
        </div>
      </div>
    )
  }
