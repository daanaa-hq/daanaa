      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-10">How to give cryptocurrency</h2>
            ...
            <div className="space-y-8">
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Check whether the nonprofit accepts it</h3>
                </div>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Know your holding period</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Transfer it and record the date</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Handle the paperwork</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65]">
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-title md:text-title-lg mb-6">Why give crypto instead of cash?</h2>
          ...
          {/* Cautions */}
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-title md:text-title-lg mb-6">Things to be careful about</h2>
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div>
                  <p className="font-body text-label tracking-[0.08em] text-link-gold uppercase mb-1">Similar rules</p>
                  <p className="font-display italic text-deep-navy text-title-sm">Giving stock</p>
                </div>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A96E" strokeWidth="2" className="shrink-0 group-hover:translate-x-1 transition-transform">
                  <polyline points="9 18 15 12 9 6" />
                </svg>
