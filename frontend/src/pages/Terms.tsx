      ...
      <div className="max-w-[800px] mx-auto px-6 lg:px-12 py-24">
        ...
        <div className="mt-12 space-y-12 font-body text-[15px] text-cool-grey leading-[1.7]">
          ...
          <section>
            ...
            <p>
              The Giving Wallet is a browser-local bookmarking tool. Organizations you save are stored in your own
              browser — not on our servers. We cannot see your wallet and do not track or store your saving activity.
            </p>
            <p className="mt-3">
              An optional sign-in (email magic link or Google) lets you sync your wallet across devices. A synced
              wallet holds bookmarks and giving intent only — never transaction records. It is never shown publicly,
              never used for marketing or outreach, and can be deleted in full at any time. Signing in is not required
              to use any feature of the site.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 ml-4 space-y-1 list-disc">
              ...
              <li>The Giving Wallet is stored on your device by default. Optional sync requires an account you control.</li>
