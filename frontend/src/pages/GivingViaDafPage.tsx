      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-6">Do you already have a DAF?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-3">Yes, I have a DAF account</h3>
                ...
                <p className="font-body text-caption text-cool-grey/70">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-3">No, I need to open one first</h3>
                <p className="font-body text-body text-cool-grey leading-[1.65] mb-4">
                  Visit a major DAF sponsor to open and fund your account.
                </p>
                <div className="space-y-2 font-body text-caption text-cool-grey/70">
          ...
          {/* Steps */}
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-10">How to grant funds to a nonprofit</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Search for the nonprofit</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65] mb-4">
                ...
                <div className="bg-soft-gold/10 border border-soft-gold/20 rounded-lg p-4 mb-4">
                  <p className="font-body text-small text-deep-navy font-medium mb-2">Tip: Use the EIN for accuracy</p>
                ...
                <p className="font-body text-small text-muted-cream/70">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Verify the charity details</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65] mb-4">
                  Confirm you have the correct organization:
                </p>
                <ul className="space-y-2 font-body text-body text-cool-grey leading-[1.65] mb-4">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Specify grant amount and purpose</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65] mb-4">
                ...
                <div className="bg-soft-gold/10 border border-soft-gold/20 rounded-lg p-4">
                  <p className="font-body text-small text-deep-navy font-medium mb-2">📋 Pro tip: Add a purpose note</p>
                  <p className="font-body text-small text-cool-grey">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Choose visibility (optional)</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65] mb-4">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <span className="font-display text-deep-navy text-title-lg">5</span>
                  <h3 className="font-display text-deep-navy text-title">Submit and confirm</h3>
                </div>
          ...
          {/* Key facts */}
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-title md:text-title-lg mb-6">Important: How DAF grants work</h2>
