      ...
      <div className="bg-warm-cream">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p>
              The <strong className="text-deep-navy font-semibold">trust tier</strong> (Beacon → Spark) reflects how much public data backs the profile today. A Beacon has a current 990 on file, a mission statement, an active website, and a top-quartile peer score. A Seed is an IRS-registered nonprofit with little financial detail yet in public records. The tier is a transparency signal, not a quality verdict.
            </p>
            <Tip>
