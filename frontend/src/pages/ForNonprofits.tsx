...
function StepDot({ n, label }: { n: number; label: string }) {
  return (
    <div className="flex items-center gap-4">
      <div className="shrink-0 w-8 h-8 rounded-full bg-soft-gold text-deep-navy font-body text-small font-bold flex items-center justify-center">
        {n}
      </div>
      <span className="font-body text-body-lg text-deep-navy">{label}</span>
    </div>
  )
}
    ...
    <div className="min-h-[100dvh]">
      ...
      <div className="bg-deep-navy pt-nav">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 pt-8 pb-12 md:pt-12 md:pb-20">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-body text-caption text-muted-cream">For Nonprofits</span>
          </div>

          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-16">
            <div className="max-w-[680px]">
              <span className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase">For organizations</span>
              ...
              <a href="#claim" className="mt-8 inline-flex items-center gap-2 px-8 py-[14px] rounded-full bg-soft-gold text-deep-navy font-body text-body font-semibold hover:bg-bright-gold transition-colors">
      ...
      <div className="bg-warm-cream py-10 md:py-16 lg:py-20">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <span className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase">What you can add for free</span>
          <h2 className="font-display italic text-deep-navy mt-3 text-headline-lg leading-[1.1] mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 max-w-[900px]">
            {[
              ...
              <div key={n} className={`flex gap-5 ${phase2 ? 'opacity-55' : ''}`}>
                <div className="shrink-0 w-8 h-8 rounded-full bg-soft-gold/15 border border-soft-gold/30 text-link-gold font-body text-small font-semibold flex items-center justify-center mt-0.5">
                  {n}
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-1.5">
                    <h3 className="font-body text-lead font-semibold text-deep-navy">{title}</h3>
                    {phase2 && (
                      <span className="px-2 py-0.5 rounded-full bg-cool-grey/10 border border-cool-grey/20 font-body text-micro text-cool-grey font-medium">Coming soon</span>
                    )}
                  </div>
                  <p className="font-body text-body text-cool-grey leading-[1.65]">{description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-white py-10 md:py-16 border-t border-light-grey">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="max-w-[680px]">
            <span className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase">Trust by design</span>
            <h2 className="font-display italic text-deep-navy mt-3 text-headline-lg leading-[1.1] mb-6">
              Government records and your story, clearly separated
            </h2>
            <p className="font-body text-lead text-cool-grey leading-[1.7] mb-4">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-[680px]">
            <div className="p-5 bg-warm-cream rounded-xl border border-light-grey">
              <p className="font-body text-label tracking-[0.06em] text-link-gold uppercase font-medium mb-3">IRS public data</p>
              <ul className="space-y-2 font-body text-small text-cool-grey">
              ...
              <p className="mt-3 font-body text-label text-cool-grey">Not editable · Always shown</p>
            </div>
            <div className="p-5 rounded-xl border-2 border-dashed border-soft-gold/30">
              <p className="font-body text-label tracking-[0.06em] text-link-gold uppercase font-medium mb-3">Your claimed content</p>
              <ul className="space-y-2 font-body text-small text-cool-grey">
              ...
              <p className="mt-3 font-body text-label text-cool-grey">Labeled "written by you" · Controlled by you</p>
            </div>
          </div>
          ...
          <div className="mt-10 max-w-[680px] p-6 rounded-xl bg-warm-cream border border-light-grey">
            <div className="flex items-start gap-4">
              <div className="shrink-0 mt-0.5">
                <span className="inline-block border border-cool-grey/30 text-cool-grey rounded text-micro px-1.5 py-0.5 font-body">AI assisted</span>
              </div>
              <div>
                <p className="font-body text-body font-semibold text-deep-navy mb-1">What the AI assisted label means</p>
                <p className="font-body text-small text-cool-grey leading-[1.65]">
                  ...
                  It is marked <span className="border border-cool-grey/30 text-cool-grey rounded text-micro px-1 py-0.5">AI assisted</span> so people know it is a starting point, not your organization’s words.
      ...
      <div className="bg-warm-cream py-10 md:py-16 border-t border-light-grey">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="max-w-[520px]">
            <span className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase">How claiming works</span>
            <h2 className="font-display italic text-deep-navy mt-3 text-headline-lg leading-[1.1] mb-8">
            ...
            <p className="mt-8 font-body text-body text-cool-grey leading-[1.6]">
      ...
      <div className="bg-warm-cream border-t border-light-grey py-10">
        <div className="max-w-[520px] mx-auto px-6">
          <p className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase mb-3">
            Already claimed your page?
          </p>
          {!user ? (
            <div className="space-y-2">
              <p className="font-body text-body-lg text-deep-navy mb-3">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                <p className="font-body text-body text-deep-navy font-medium">{user.email}</p>
                <p className="font-body text-small text-cool-grey">Signed in</p>
              </div>
              <button
                onClick={async () => {
                ...
                className="px-5 py-2.5 bg-soft-gold text-deep-navy font-body text-body font-semibold rounded-xl hover:bg-bright-gold disabled:opacity-40 transition-colors"
              >
          ...
          {portalError && (
            <p className="mt-3 font-body text-small text-destructive">{portalError}</p>
          )}
        </div>
      </div>
          ...
          <div className="max-w-[520px]">
            {submitted ? (
              <div className="py-8">
                ...
                <h3 className="font-display italic text-warm-cream text-headline mb-3">
                  Claim received. We'll call you
                  {orgName && <span className="block text-link-gold text-title mt-1">{orgName}</span>}
                </h3>
                <p className="font-body text-body-lg text-muted-cream leading-[1.6] mb-4">
                  A member of the Daanaa team will call the number you provided, usually within 1 to 2 business days, to confirm your role.
                </p>
                <p className="font-body text-body text-muted-cream leading-[1.6] mb-6">
                ...
                <Link to="/directory" className="inline-block font-body text-body text-link-gold hover:text-bright-gold transition-colors">
                  Browse the directory →
                </Link>
              </div>
            ) : (
              <>
                <span className="font-body text-label font-medium tracking-[0.08em] text-link-gold uppercase">
                  Claim your page
                </span>
                <h2 className="font-display italic text-warm-cream mt-3 text-headline-lg leading-[1.1] mb-3">
                  {orgName ? orgName : 'Is this your nonprofit?'}
                </h2>
                <p className="font-body text-lead text-muted-cream leading-[1.65] mb-6">
                ...
                {irsAddress && (
                  <div className="mb-6 p-4 rounded-xl border border-soft-gold/20 bg-navy-mid/50">
                    <p className="font-body text-label text-muted-cream uppercase tracking-[0.06em] mb-1">IRS-registered address on file</p>
                    <p className="font-body text-body text-warm-cream">{irsAddress}</p>
                    <p className="font-body text-label text-muted-cream mt-1">IRS-registered address · public record</p>
                  </div>
                )}

                <form onSubmit={handleSubmit} className="space-y-3">
                  <div>
                    <label className="block font-body text-caption text-muted-cream mb-1.5">
                    ...
                    <input
                      ...
                      className="w-full h-[48px] bg-navy-mid border border-soft-gold/20 text-warm-cream px-4 rounded-xl font-body text-body-lg outline-none focus:border-soft-gold transition-colors placeholder:text-cool-grey"
                    />
                  </div>
                  ...
                  <div className="mt-2 p-4 rounded-xl border border-soft-gold/20 bg-navy-mid/50 space-y-2.5">
                    <p className="font-body text-caption font-semibold text-warm-cream">
                      Before you sign, here is who we are and what happens with this form.
                    </p>
                    <p className="font-body text-caption text-muted-cream leading-[1.6]">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer pt-2">
                    ...
                    />
                    <span className="font-body text-caption text-muted-cream leading-[1.6]">
                  ...
                  {error && (
                    <p className="font-body text-small text-red-400 leading-[1.5]">{error}</p>
                  )}

                  <button
                    type="submit"
                    disabled={submitting || !attested || !attestedLegal}
                    className="w-full h-[48px] bg-soft-gold text-deep-navy font-body text-body font-semibold rounded-full hover:bg-bright-gold transition-colors disabled:opacity-60"
                  >
                    {submitting ? 'Submitting…' : 'Submit claim request'}
                  </button>
                </form>
                <p className="mt-4 font-body text-label text-muted-cream leading-[1.5]">
