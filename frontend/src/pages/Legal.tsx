      ...
      <div className="bg-warm-cream py-16 md:py-20">
        ...
        <div className="space-y-12 font-body text-[16px] text-cool-grey leading-[1.7]">
          ...
          <section>
            ...
            <p className="mt-5 font-semibold text-deep-navy">Copyright and takedowns</p>
            <p className="mt-2">
              If you believe content on Daanaa infringes your copyright, contact us at{' '}
              <a href="mailto:legal@daanaa.org" className="text-soft-gold hover:underline">legal@daanaa.org</a>{' '}
              with a description of the material, the URL where it appears, and your contact information.
