  ...
  return (
    <div className="min-h-[100dvh]">
      <div className="bg-deep-navy pt-nav">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12 pt-12 pb-10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <Link to="/legal" className="font-body text-caption text-muted-cream hover:text-warm-cream transition-colors">Legal</Link>
            <span className="text-muted-cream">/</span>
            <span className="font-body text-caption text-muted-cream">Privacy Policy</span>
          </div>
      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[800px] mx-auto px-6 md:px-12 space-y-14 font-body text-lead text-cool-grey leading-[1.7]">

          {/* Top-level notice */}
          <div className="p-5 bg-deep-navy/5 border border-deep-navy/10 rounded-xl">
            <p className="font-body text-body-lg font-semibold text-deep-navy">
          ...
          {/* 1. Who we are */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Who we are</h2>
            <p>
          ...
          <section>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-2">The Giving Wallet</h3>
                <p className="text-body">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-2">Feedback and contact forms</h3>
                <p className="text-body">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-2">Claiming an organization page</h3>
                <p className="text-body">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-2">Volunteer submissions</h3>
                <p className="text-body">
              ...
              <div className="bg-white border border-light-grey rounded-xl p-6">
                <h3 className="font-display text-deep-navy text-title-sm mb-2">What we never collect</h3>
                <ul className="text-body space-y-1.5 mt-1">
                  {[
          ...
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">How we use information</h2>
          ...
          {/* 4. Data retention */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Data retention</h2>
          ...
          {/* 5. Third parties */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Third parties and data sharing</h2>
          ...
          {/* 6. Cookies */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Cookies</h2>
            <p>
            ...
            <ul className="mt-4 space-y-3">
              {[
                ...
                <li key={c.type} className="flex gap-4 p-4 bg-white border border-light-grey rounded-lg text-body">
                  <div>
          ...
          {/* 7. Children */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Children's privacy</h2>
            <p>
          ...
          {/* 8. State rights */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Your privacy rights</h2>
            <p>
            ...
            <div className="mt-6 space-y-4 p-5 bg-white border border-light-grey rounded-xl text-body">
          ...
          {/* 9. Security */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Security</h2>
            <p>
          ...
          {/* 10. Changes */}
          <section>
            <h2 className="font-display italic text-deep-navy text-title-lg md:text-headline mb-4">Changes to this policy</h2>
            <p>
          ...
          <div className="pt-6 border-t border-light-grey flex flex-wrap gap-6">
            <Link to="/legal" className="font-body text-small text-deep-navy/70 hover:text-deep-navy">Terms of Use →</Link>
            <Link to="/legal#data-sources" className="font-body text-small text-deep-navy/70 hover:text-deep-navy">Data Sources →</Link>
            <Link to="/about" className="font-body text-small text-deep-navy/70 hover:text-deep-navy">About Daanaa →</Link>
            <Link to="/feedback" className="font-body text-small text-deep-navy/70 hover:text-deep-navy">Contact →</Link>
          </div>

          <p className="text-caption text-cool-grey pt-2 border-t border-light-grey">
