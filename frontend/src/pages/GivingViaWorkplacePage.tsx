      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-[26px] md:text-[32px] mb-10">How workplace giving works</h2>

            <div className="space-y-8">
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  <span className="font-display text-deep-navy text-[24px]">1</span>
                  <h3 className="font-display text-deep-navy text-[20px]">Ask your employer what they offer</h3>
                </div>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Find the nonprofit and its EIN</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Set your amount</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-[20px]">Keep your pay stubs</h3>
                </div>
                <p className="font-body text-[15px] text-cool-grey leading-[1.65]">
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-[20px] md:text-[24px] mb-6">Why give through work?</h2>
          ...
          {/* Common platforms */}
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-[20px] md:text-[24px] mb-6">Platforms employers commonly use</h2>
            <p className="font-body text-[14px] text-cool-grey leading-[1.65] mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                <div key={i} className="bg-white border border-light-grey rounded-xl p-6">
                  <h3 className="font-display text-deep-navy text-[16px] mb-3">{item.name}</h3>
                  <p className="font-body text-[13px] text-cool-grey leading-[1.65]">{item.body}</p>
                </div>
              ))}
            </div>
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div>
                  <p className="font-body text-[11px] tracking-[0.08em] text-link-gold uppercase mb-1">Another way</p>
                  <p className="font-display italic text-deep-navy text-[18px]">Recurring gifts</p>
                </div>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#C9A96E" strokeWidth="2" className="shrink-0 group-hover:translate-x-1 transition-transform">
                  <polyline points="9 18 15 12 9 6" />
                </svg>
