      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12">
          ...
          <section className="mb-16">
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-10">How to give via platforms</h2>
            ...
            <div className="space-y-8">
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Pick a platform</h3>
                </div>
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Donate</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65]">
              ...
              <div className="border-l-4 border-soft-gold pl-6">
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <h3 className="font-display text-deep-navy text-title">Get a receipt</h3>
                </div>
                <p className="font-body text-body-lg text-cool-grey leading-[1.65]">
          ...
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-10">Popular giving platforms</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                >
                  <h3 className="font-display text-deep-navy text-title mb-3 group-hover:text-link-gold transition-colors">
                    {platform.name}
                  </h3>
                  <p className="font-body text-body text-cool-grey leading-[1.65] mb-4">
                    {platform.description}
                  </p>
                  <p className="font-body text-small text-link-gold group-hover:text-bright-gold transition-colors">
                    {platform.cta} →
                  </p>
                </a>
              ))}
            ...
            <p className="font-body text-small text-muted-cream/70 mt-8 italic">
          ...
          {/* EIN-based search */}
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-title md:text-title-lg mb-6">What's an EIN?</h2>
          ...
          {/* Privacy & fees */}
          <section className="mb-16 pt-12 border-t border-light-grey">
            <h2 className="font-display italic text-deep-navy text-title md:text-title-lg mb-6">Fees & privacy</h2>
