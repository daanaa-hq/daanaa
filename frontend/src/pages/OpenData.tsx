    ...
    <div className="min-h-[100dvh] bg-warm-cream">
      <div className="bg-deep-navy pt-[72px]">
        <div className="max-w-[1120px] mx-auto px-6 md:px-12 pt-14 pb-14">
          ...
          <p className="mt-5 max-w-[760px] font-body text-title-sm leading-[1.7] text-muted-cream">
      ...
      <div className="max-w-[1120px] mx-auto px-6 md:px-12 py-16 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.9fr] gap-10 lg:gap-14">
          <div>
            <h2 className="font-display italic text-deep-navy text-headline md:text-headline-lg mb-6">Canonical resources</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {RESOURCES.map(resource => (
                ...
                >
                  <p className="font-body text-label tracking-[0.08em] text-link-gold uppercase mb-2">{resource.title}</p>
                  <p className="font-body text-body font-medium text-deep-navy mb-2">{resource.href}</p>
                  <p className="font-body text-body leading-[1.65] text-cool-grey">{resource.description}</p>
                </a>
              ))}
            </div>

            <div className="mt-10 p-6 rounded-2xl bg-white border border-light-grey">
              <h2 className="font-display italic text-deep-navy text-title-lg mb-4">What to cite</h2>
              <div className="space-y-3 font-body text-body-lg leading-[1.7] text-cool-grey">
          ...
          <aside className="lg:pt-2">
            <div className="sticky top-[88px] space-y-5">
              <div className="rounded-2xl border border-light-grey bg-deep-navy p-6">
                <p className="font-body text-label tracking-[0.1em] text-pale-gold uppercase mb-3">For automated tools</p>
                <p className="font-body text-body-lg leading-[1.7] text-muted-cream">
              ...
              <div className="rounded-2xl border border-light-grey bg-white p-6">
                <p className="font-body text-label tracking-[0.1em] text-link-gold uppercase mb-3">For search engines</p>
                <p className="font-body text-body-lg leading-[1.7] text-cool-grey">
