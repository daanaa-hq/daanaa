...
export default function TiersPage() {
  usePageMeta('Visibility Levels', 'Understand the four Daanaa visibility levels (Beacon, Torch, Candle, and Spark) and what each means for the nonprofits the IRS recognizes.')
  return (
      ...
      <div className="bg-deep-navy pt-nav">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 pt-12 pb-16">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-body text-caption text-muted-cream">Visibility Levels</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-16">
            <div className="flex items-start gap-6">
              ...
              <div className="max-w-[640px]">
                <span className="font-body text-label font-medium tracking-[0.08em] text-soft-gold uppercase">How much information is available</span>
      ...
      <div className="bg-warm-cream py-16 md:py-20">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-[720px] mb-14">
            <p className="font-body text-lead leading-[1.7] text-cool-grey">
            ...
            <p className="font-body text-lead leading-[1.7] text-cool-grey mt-4">
                ...
                >
                  ...
                  <div className="flex items-start gap-5 p-6 md:p-8">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 flex-wrap">
                        <h2
                          className="font-display text-headline leading-none"
                          style={{ fontFamily: 'Cinzel, serif', color }}
                        >
                          {name}
                        </h2>
                        <span
                          className="font-body text-label font-semibold px-2.5 py-0.5 rounded-full"
                          style={{ backgroundColor: `${color}15`, color }}
                        >
                          {pct} of indexed 501(c)(3)s · {count}
                        </span>
                      </div>
                      <p className="mt-2.5 font-body text-body-lg leading-[1.6] text-cool-grey max-w-[560px]">
                        {TIER_MICROCOPY[name]}
                      </p>
                    </div>
                    ...
                    <Link
                      ...
                      className="hidden md:inline-flex items-center gap-1.5 shrink-0 font-body text-small font-semibold px-4 py-2 rounded-full border transition-all duration-150 hover:bg-soft-gold/10"
                  ...
                  <div className="border-t border-light-grey px-6 md:px-8 py-5 flex flex-col md:flex-row gap-6 md:gap-10 bg-warm-cream/40">
                    ...
                    <div className="flex-1">
                      <p className="font-body text-micro font-semibold tracking-[0.08em] text-cool-grey uppercase mb-3">
                    ...
                    <div className="md:w-[280px] shrink-0">
                      {nextPath ? (
                        <>
                          ...
                          <p className="font-body text-small leading-[1.6] text-cool-grey">
                            {nextPath}
                          </p>
                        </>
                      ) : (
                        <div className="flex items-start gap-2.5">
                          ...
                          <p className="font-body text-small leading-[1.6]" style={{ color }}>
                  ...
                  <div className="md:hidden px-6 pb-5">
                    <Link
                      to={name === 'Spark' ? '/directory' : `/directory?min_tier=${name}`}
                      className="inline-flex items-center gap-1.5 font-body text-small font-semibold"
                      style={{ color }}
                    >
          ...
          <div className="mt-16 max-w-[720px]">
            ...
            <div className="mt-4 space-y-4 font-body text-lead text-cool-grey leading-[1.7]">
              <p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/methodology"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-deep-navy text-warm-cream font-body text-small font-semibold hover:bg-navy-mid transition-colors"
              >
                How scoring works
              </Link>
              <Link
                to="/directory"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-soft-gold/40 text-soft-gold font-body text-small font-semibold hover:bg-soft-gold/10 transition-colors"
              >
