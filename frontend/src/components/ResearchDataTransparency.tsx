    ...
    <CardPattern variant="default">
      ...
      <CardPattern variant="nested" className="mb-6">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="font-body text-label text-cool-grey uppercase tracking-wide mb-1">
              Latest Tax Year
            </p>
            <p className="font-display text-title font-bold text-deep-navy">
          ...
          <div>
            ...
            <p className="font-display text-body font-semibold text-deep-navy">
      ...
      <div className="space-y-3 mb-6">
        <p className="font-body text-caption font-semibold text-deep-navy uppercase tracking-wide">
          Financial Metrics
        </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-3 rounded-lg bg-blue-50 border border-blue-100">
            <p className="font-body text-label text-cool-grey mb-1">Total Revenue</p>
            <p className="font-display text-lead font-bold text-blue-900">
              {org.total_revenue ? formatCurrency(org.total_revenue) : 'N/A'}
            </p>
            <p className="font-body text-micro text-cool-grey mt-1">
          ...
          <div className="p-3 rounded-lg bg-green-50 border border-green-100">
            <p className="font-body text-label text-cool-grey mb-1">Program Expense %</p>
            <p className="font-display text-lead font-bold text-green-900">
          ...
          <div className="p-3 rounded-lg bg-alert-amber/5 border border-amber-100">
            <p className="font-body text-label text-cool-grey mb-1">Months of Reserve</p>
            <p className="font-display text-lead font-bold text-amber-900">
          ...
          <div className="p-3 rounded-lg bg-purple-50 border border-purple-100">
            <p className="font-body text-label text-cool-grey mb-1">Total Expenses</p>
            <p className="font-display text-lead font-bold text-purple-900">
      ...
      {isStale && (
        <CardPattern variant="nested" className="mb-6 border-alert-amber/30 bg-alert-amber/5">
          <p className="font-body text-small text-amber-900 mb-2">
          ...
          <p className="font-body text-caption text-amber-800">
      ...
      <div className="pt-6 border-t border-slate-200">
        <div className="mb-4">
          <p className="font-body text-small font-semibold text-deep-navy mb-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-soft-gold text-deep-navy font-body text-small font-semibold hover:bg-bright-gold transition-colors"
        >
