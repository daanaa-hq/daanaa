...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: `Daanaa indexes over 1.7 million tax-deductible nonprofits, and almost none are ones you have heard of. Search by cause, by place, or in plain words, like 'after school reading help in Austin', and meet the overlooked ones doing real good.`,
  },
  {
    tag: 'Context',
