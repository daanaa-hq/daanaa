...
module.exports = {
  ...
  // (set by /theme-init.js and by ThemeContext). There is no
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Cause palette — generated by scripts/generate_cause_palette.py.
        // One hue per NCCS family, surface/border/text derived by a per-theme
        // recipe, so the chips are theme-aware instead of light-only. Values
        // live in tokens.css; regenerate rather than editing either file.
        'cause-arts-surface': 'var(--cause-arts-surface)',
        'cause-arts-border': 'var(--cause-arts-border)',
        'cause-arts-text': 'var(--cause-arts-text)',
        'cause-education-surface': 'var(--cause-education-surface)',
        'cause-education-border': 'var(--cause-education-border)',
        'cause-education-text': 'var(--cause-education-text)',
        'cause-environment-surface': 'var(--cause-environment-surface)',
        'cause-environment-border': 'var(--cause-environment-border)',
        'cause-environment-text': 'var(--cause-environment-text)',
        'cause-health-surface': 'var(--cause-health-surface)',
        'cause-health-border': 'var(--cause-health-border)',
        'cause-health-text': 'var(--cause-health-text)',
        'cause-human-surface': 'var(--cause-human-surface)',
        'cause-human-border': 'var(--cause-human-border)',
        'cause-human-text': 'var(--cause-human-text)',
        'cause-global-surface': 'var(--cause-global-surface)',
        'cause-global-border': 'var(--cause-global-border)',
        'cause-global-text': 'var(--cause-global-text)',
        'cause-public-surface': 'var(--cause-public-surface)',
        'cause-public-border': 'var(--cause-public-border)',
        'cause-public-text': 'var(--cause-public-text)',
        'cause-religion-surface': 'var(--cause-religion-surface)',
        'cause-religion-border': 'var(--cause-religion-border)',
        'cause-religion-text': 'var(--cause-religion-text)',
        'cause-mutual-surface': 'var(--cause-mutual-surface)',
        'cause-mutual-border': 'var(--cause-mutual-border)',
        'cause-mutual-text': 'var(--cause-mutual-text)',
        'cause-unknown-surface': 'var(--cause-unknown-surface)',
        'cause-unknown-border': 'var(--cause-unknown-border)',
        'cause-unknown-text': 'var(--cause-unknown-text)',
        'link-gold': '#7A5C2E',
